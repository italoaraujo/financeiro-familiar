        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 sm:p-8 shadow-2xl backdrop-blur-xl">
          {registrationEnabled === false ? (
            <div className="text-center py-4">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-white mb-2">Cadastros Temporariamente Desativados</h2>
              <p className="text-xs sm:text-sm text-slate-400 max-w-sm mx-auto mb-6 leading-relaxed">
                O cadastro de novos usuários está suspenso pelo administrador do sistema. Se você já possui uma conta, acesse o sistema através da página de login.
              </p>
              <Link
                href="/login"
                className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-slate-950 font-semibold py-2.5 sm:py-3 px-4 rounded-xl shadow-lg shadow-emerald-500/20 transition-all duration-200 text-xs sm:text-sm"
              >
